...
export default class FlowSourceController {
    constructor() {}
    ...
    async getInfo(args: any, ctx: Context): Promise<void> {
        ...
        //     throw new Error('请检查参数 begin_date、end_date');
        // }
        const params = Object.assign({
            'date_type': 21,
            begin_date: '2022/10/27 00:00:00',
            end_date: '2022/11/02 00:00:00',
            is_activity: false,
            activity_id: '',
        ...
        try {
            const res: any = await get(
                'https://compass.jinritemai.com/compass_api/shop/product/product_detail/flow_source',
